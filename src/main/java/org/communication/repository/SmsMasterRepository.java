...
public interface SmsMasterRepository extends JpaRepository<SmsMaster, Integer> {
    ...
    @Query("""
            select new org.communication.dto.SmsDetailsDto(s.priority,s.id,stm.version,stm.govTemplateCode,stm.serviceProviderTemplateCode,ssm.senderCode,spm.apiKey,spm.url) from SmsMaster s 
