...
public class MailTemplateDetail {
    ...
    public MailTemplateDetail(String subject, String body, int templateMastId, Double version, LocalDateTime createdAt, LocalDateTime updatedAt, String isActive, String fromEmailId) {
