...
public class MailTemplateDetailsService {
    ...
    public MailTemplateDetailsService(MailTemplateDetailsValidator mailTemplateDetailsValidator, MailTemplateDetailRepository mailTemplateDetailRepository, MessageService messageService) {
    ...
    public ResponseBean<MailTemplateDetail> createTemplateDetail(MailTemplateDetailsDto mailTemplateDetailsDto) {
        ...
        return new ResponseBean<>(HttpStatus.OK, ConstCore.rCode.SUCCESS, messageService.getMessage("TEMPLATE_DETAILS_ADD"), messageService.getMessage("TEMPLATE_DETAILS_ADD"), mailTemplateDetails);
    }
    ...
    public ResponseBean<?> getTemplateDetail(int templateMastId) {
        ...
        return new ResponseBean<>(HttpStatus.OK, ConstCore.rCode.SUCCESS, messageService.getMessage("TEMPLATE_DETAILS_FETCH"), messageService.getMessage("TEMPLATE_DETAILS_FETCH"), templateDetailsByMailTemplateMastId);
    }
