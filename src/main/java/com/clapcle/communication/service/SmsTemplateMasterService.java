...
public class SmsTemplateMasterService {
    ...
    public ResponseBean<Map<String, Object>> addOrUpdateSmsTemplate(SmsTemplateMasterDto smsTemplateMasterDto) {
        ...
        return new ResponseBean<>(HttpStatus.OK, ConstCore.rCode.SUCCESS, messageService.getMessage("SMS_TEMPLATE_ADD"), messageService.getMessage("SMS_TEMPLATE_ADD"), res);
    ...
    public ResponseBean<SmsTemplateMaster> findSmsTemplateById(Integer id) {
        ...
        if (templateMaster.isPresent()) {
            return new ResponseBean<>(HttpStatus.OK, ConstCore.rCode.SUCCESS, messageService.getMessage("TEMPLATE_FETCH"), messageService.getMessage("TEMPLATE_FETCH"), templateMaster.get());
        }
        return new ResponseBean<>(HttpStatus.OK, ConstCore.rCode.SUCCESS, messageService.getMessage("TEMPLATE_FETCH"), messageService.getMessage("TEMPLATE_FETCH"), null);
